          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-muted-foreground py-8 text-center">
                No maintenance requests yet. Add a property and share the public link with your tenants.
              </div>
            ) : (
                  ...
                  <tbody>
                    {recentRequests.map((req: any) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2 text-muted-foreground">{format(new Date(req.created_at), "MMM d")}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
